...
$titulosColumnas = array('Fecha','Nombre','Rut','Promoclub','Ciudad');
...
for ($i=0; $i < count($arregloPromo[$mesBuscado]); $i++) { 
	...
	$objPHPExcel->setActiveSheetIndex(0)
         ...
         ->setCellValue('D'.($i+4), $arregloPromo[$mesBuscado][$i]['cupon'])
         ->setCellValue('E'.($i+4), $arregloPromo[$mesBuscado][$i]['ciudadRelacionada']);
...
$objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, "A4:E".($i+3));
